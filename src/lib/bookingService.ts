...
import type { BookingFormData, ContactFormData, SubmitResult } from './types'

export const submitBooking = (formData: BookingFormData): Promise<SubmitResult> =>
  new Promise((resolve) => {
    setTimeout(() => {
...
export const submitContactForm = (formData: ContactFormData): Promise<SubmitResult> =>
  new Promise((resolve) => {
    setTimeout(() => {
