...
import { getTourBySlug, getRelatedTours, tours } from '@/lib/toursData'
        ...
        <div className="container tour-detail__layout">
          <div className="tour-detail__main">
            ...
            <div className="tour-detail__block">
              ...
              <Link href="/reviews" className="tour-detail__all-reviews">See all reviews →</Link>
            </div>

            <div className="tour-detail__mobile-cta">
              <Link href={`/booking?tour=${tour.slug}`} className="btn btn-primary btn-block">
